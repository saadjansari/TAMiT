function [costMat,propagationScheme,kalmanFilterInfoFrame2,nonlinkMarker,...
    errFlag] = costMatRandomDirectedSwitchingMotionLinkSA(movieInfo,kalmanFilterInfoFrame1,...
    costMatParam,probDim,featLifetime,currentFrame)
...
if nargin ~= nargin('costMatRandomDirectedSwitchingMotionLinkSA')
