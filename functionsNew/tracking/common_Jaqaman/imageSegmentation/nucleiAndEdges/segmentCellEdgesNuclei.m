...
if nargin < 2
    disp('--segmentCellEdgesNuclei: Please enter images of nuclei and cell edges.')
    return
end
...
for i=1:size(centersNuclei,1)
    M(centersNuclei(i,2),centersNuclei(i,1)) = 1;
end

%do the watershed
watershedEdges = myWatershed(imageCfilter-maskNuclei,4,M);
