function [costMat,nonlinkMarker,indxMerge,numMerge,indxSplit,numSplit,...
    errFlag] = costMatRandomDirectedSwitchingMotionAsterCloseGaps(trackedFeatInfo,...
...
%costMatRandomDirectedSwitchingMotionAsterCloseGaps provides a cost matrix for closing gaps and capturing merges/splits using Kalman filter information
%
...
%                        [L1 th1 phi1 a1 dL1 dth1 dphi1 da1 L2 th2 phi2 a2 dL2 dth2 dphi2 da2 ...]
%                        in image coordinate system (coordinates in
%                        pixels/radians). NaN is used to indicate time points
...
%get the L, theta, phi-coordinates and amplitudes at the starts of tracks
...
%get the L, theta, phi-coordinates and amplitudes at the ends of tracks
...
for iFrame = 1 : numFrames - 1
    ...
    for jFrame = iFrame + 1 : min(iFrame+timeWindow,numFrames)
        ...
        dispMat2 = createDistanceMatrixPolar(coordEnd(endsToConsider,:),...
