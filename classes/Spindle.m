...
%             Image2Find = Image2Find .* imSpinLog;
            ...
            [feature{1}, suc1] = obj.featureList{2}.findBestMissingFeature( obj.image, Image2Find, spindleAngle(1), spindleExclusionRange);
            [feature{2}, suc2] = obj.featureList{3}.findBestMissingFeature( obj.image, Image2Find, spindleAngle(2), spindleExclusionRange);
