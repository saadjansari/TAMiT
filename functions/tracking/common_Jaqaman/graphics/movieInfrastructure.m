function movieVar = movieInfrastructure(whatToDo,movieType,dir2saveMovie,...
    movieName,numFramesMovie,movieVar,iFrame,curr_cell)
curr_cell = 1;
switch whatToDo
    ...
    case 'initialize' %initialize movie
        ...
        switch movieType
            case 'mov'
                ...
                MakeQTMovie('start', [ fullfile(dir2saveMovie,movieName) '_Cell_' num2str(curr_cell) '.mov']) % Edit by Tony so that file names with spaces can be used
