function overlayTracksMovieNewMB(tracksFinal,startend,dragtailLength,...
...
%OVERLAYTRACKSMOVIENEWMB overlays tracks obtained via trackCloseGapsKalman on movies with variable color-coding schemes
%
%SYNPOSIS overlayTracksMovieNewMB(tracksFinal,startend,dragtailLength,...
%    saveMovie,movieName,filterSigma,classifyGaps,highlightES,showRaw,...
%    imageRange,onlyTracks,classifyLft,diffAnalysisRes,intensityScale,...
...
%                       intensities, 3 to have user-defined scale (see
%                       below)
%                       Optional. Default: 1.
...
%       intensityRange: min and max intensity values to use in the movie,
%                       in the form [minIntensity maxIntensity]
%OUTPUT the movie.
%
...
%Meredith Betterton modified April 2016
...
switch intensityScale
    ...
    case 3
        intensityMinMax = intensityRange;
end
